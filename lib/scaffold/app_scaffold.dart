...
class _MaterialScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBody: extendBody,
      extendBodyBehindAppBar: extendBodyBehindAppBar,
      body: withSafeArea ? SafeArea(top: top, bottom: bottom, right: right, left: left, child: body) : body,
      backgroundColor: backgroundColor,
      floatingActionButton: floatingActionButton,
      floatingActionButtonLocation: floatingActionButtonLocation,
      bottomNavigationBar: bottomNavigationBar,
...
extension PopScopeX on Widget {
  ...
  Widget withPopScope(void Function(bool, dynamic)? onPopInvokedWithResult, {bool? canPop}) =>
